<main class="app-main">
  <div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h3 class="mb-0">Hapus Dosen</h3>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Hapus Dosen</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-6">
                  ...
                  if (isset($_GET['id'])) {
                    $xid = $_GET['id'];
                    $sql = "DELETE FROM dosen WHERE id='$xid'";
                    $query = $konek->query($sql);

                    if ($query) {
                      echo "<div class='alert alert-success'>Data dosen berhasil dihapus.</div>";
                    } else {
                      echo "<div class='alert alert-danger'>Data dosen gagal dihapus.</div>";
                    }
                  } else {
