...
if (isset($_POST['simpan'])) {
    ...
    $sql = "UPDATE mhs SET nim='$nim', nama='$nama', alamat='$alamat', `jenis_kelamin`='$jk', prodi='$prodi' WHERE id='$xid'";
    $a = $konek->query($sql);

    if ($a) {
        echo "<div class='alert alert-success'>Berhasil diedit! <a href='./?p=mahasiswa'>Lihat Data!</a></div>";
    }
}
?>
                ...
                <div class="col-6">
                  ...
                  foreach ($data as $d) {
                      ...
                      <table class='table table-bordered table-hover table-striped'>
                        <tr>
                          <td>NIM</td>
                          <td>: <input type='number' value='{$d['nim']}' name='nim'></td>
                        </tr>
                        <tr>
                          <td>NAMA</td>
