...
// total admin
$q_adm = mysqli_query($konek, "SELECT COUNT(*) AS total FROM users WHERE level='admin'");
$adm = mysqli_fetch_assoc($q_adm);
?>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title">SELAMAT DATANG, <span class="badge bg-danger ms-2">Super Admin</span></h3>
